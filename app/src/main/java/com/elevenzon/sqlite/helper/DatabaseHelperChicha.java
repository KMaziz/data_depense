...
public class DatabaseHelperChicha extends SQLiteOpenHelper {

    //database name
    public static final String DATABASE_NAME = "11zon";
    //database version
    public static final int DATABASE_VERSION = 1;
    public static final String TABLE_NAME = "chicha";

    public DatabaseHelperChicha(Context context) {
    ...
    //add the new note
    public void addchicha(String title, Double des, String date) {
    ...
    //get the all notes
    public ArrayList<chicha> getchicha() {
    ...
    //update the note
    public void updatechicha(String title, String des, long ID, String date) {
        SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
        ContentValues values =  new ContentValues();
        values.put("Title", title);

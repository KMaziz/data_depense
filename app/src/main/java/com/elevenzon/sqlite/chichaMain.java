...
public class chichaMain extends AppCompatActivity {

    ArrayList<chicha> arrayList=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chicha_main);


        recyclerView = (RecyclerView) findViewById(R.id.recycler_viewchicha);
        actionButton = (FloatingActionButton) findViewById(R.id.addchicha);
        displayNotes();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, updateProductUrl,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        chichaAdapter adapter = new chichaAdapter(getApplicationContext(), chichaMain.this, arrayList);
    ...
    public void showDialog() {
        ...
        edittext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(chichaMain.this, date, myCalendar
        ...
        submit.setOnClickListener(new View.OnClickListener() {;
            ...
            public void onClick(View v) {
                if (title.getText().toString().isEmpty()) {
                    ...
                    String updateProductUrl = server.URL_ADD_CHICHA;

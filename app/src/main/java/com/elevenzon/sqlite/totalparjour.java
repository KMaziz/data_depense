...
public class totalparjour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_totalparjour);
        Intent intent = getIntent();
        final String value = intent.getStringExtra("key"); //if it's a string you stored.

        textView =(TextView) findViewById(R.id.textViewtot);
        textView.setText(" ");

        chichabtn=(Button) findViewById(R.id.chichabtnall);
        stockbtn=(Button) findViewById(R.id.stockbtnall);
        autrebtn=(Button) findViewById(R.id.autrebtnall);
        contoirebtn=(Button) findViewById(R.id.contoirebtnall);
        getallstaff(value);

        getallstock(value);
        getallchicha(value);
        getallautre(value);
        getallcontoire(value);
        ...
        handler.postDelayed(new Runnable() {
            public void run() {
                ...
                textView.setText("le totale pour le "+value+" est : "+total+"dt");
        ...
        chichabtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Dialog dialog = new Dialog(totalparjour.this);
                ...
                chichaAdapter adapter = new chichaAdapter(getApplicationContext(), totalparjour.this, chichaList);
...
dialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
    ...
    public void onDismiss(DialogInterface dialogInterface) {
        ...
        autrebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                rv.setLayoutManager(new LinearLayoutManager(getApplicationContext(), LinearLayoutManager.VERTICAL, false));
                rv.setItemAnimator(new DefaultItemAnimator());
                NotesAdapter adapter = new NotesAdapter(getApplicationContext(), totalparjour.this, notelist);
                rv.setAdapter(adapter);
                dialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                    @Override
                    public void onDismiss(DialogInterface dialogInterface) {
        ...
        stockbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                rv.setLayoutManager(new LinearLayoutManager(getApplicationContext(), LinearLayoutManager.VERTICAL, false));
                rv.setItemAnimator(new DefaultItemAnimator());
                stockAdapter adapter = new stockAdapter(getApplicationContext(), totalparjour.this, stockList);
                rv.setAdapter(adapter);
                dialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                    @Override
                    public void onDismiss(DialogInterface dialogInterface) {
        ...
        contoirebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                rv.setLayoutManager(new LinearLayoutManager(getApplicationContext(), LinearLayoutManager.VERTICAL, false));
                rv.setItemAnimator(new DefaultItemAnimator());
                contoireAdapter adapter = new contoireAdapter(getApplicationContext(), totalparjour.this, contoireList);
                rv.setAdapter(adapter);
                dialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                    @Override
                    public void onDismiss(DialogInterface dialogInterface) {
    ...
    private void getallcontoire(final String value) {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        for (int i = 0; i < allcontoire.size(); i++) {
                            if (allcontoire.get(i).getDate().trim().equals(value.trim())) {
    ...
    private void getallautre(final String value) {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        for (int i = 0; i < allnote.size(); i++) {
                            if (allnote.get(i).getDate().trim().equals(value.trim())) {
    ...
    private void getallchicha(final String value) {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        for (int i = 0; i < allchicha.size(); i++) {
                            if (allchicha.get(i).getDate().trim().equals(value.trim())) {
    ...
    private void getallstock(final String value) {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        for (int i = 0; i < allstock.size(); i++) {
                            if (allstock.get(i).getDate().trim().equals(value.trim())) {

...
public class chichaAdapter  extends RecyclerView.Adapter<chichaAdapter.viewHolder> {

    Context context;
    Activity activity;
    ArrayList<chicha> arrayList;
    final Calendar myCalendar = Calendar.getInstance();

    public chichaAdapter(Context context,Activity activity, ArrayList<chicha> arrayList) {
    ...
    @Override
    public chichaAdapter.viewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.notes_list, viewGroup, false);
        return new chichaAdapter.viewHolder(view);
    }

    @SuppressLint("RecyclerView")
    @Override
    public void onBindViewHolder(final chichaAdapter.viewHolder holder, final   int position) {
                ...
                new AlertDialog.Builder(activity)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener()
                        {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                String updateProductUrl = server.URL_DELETE_CHICHA;
        ...
        submit.setOnClickListener(new View.OnClickListener() {;
            ...
            public void onClick(View v) {
                if (title.getText().toString().isEmpty()) {
                    ...
                    String updateProductUrl = server.URL_UPDATE_CHICHA;
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, updateProductUrl,
                            new Response.Listener<String>() {
                                @Override
                                public void onResponse(String response) {

...
public class stockAdapter extends RecyclerView.Adapter<stockAdapter.viewHolder> {
    ...
    public stockAdapter(Context context,Activity activity, ArrayList<stock> arrayList) {
                ...
                new AlertDialog.Builder(activity)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener()
                        {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                String updateProductUrl = server.URL_DELETE_STOCK;
        ...
        submit.setOnClickListener(new View.OnClickListener() {;
            ...
            public void onClick(View v) {
                if (title.getText().toString().isEmpty()) {
                    ...
                    String updateProductUrl = server.URL_UPDATE_STOCK;
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, updateProductUrl,
                            new Response.Listener<String>() {
                                @Override
                                public void onResponse(String response) {

...
public class notemain extends AppCompatActivity {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, updateProductUrl,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        NotesAdapter adapter = new NotesAdapter(getApplicationContext(), notemain.this, arrayList);
    ...
    public void showDialog() {
        ...
        edittext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(notemain.this, date, myCalendar
        ...
        submit.setOnClickListener(new View.OnClickListener() {;
            ...
            public void onClick(View v) {
                if (title.getText().toString().isEmpty()) {
                    ...
                    String updateProductUrl = server.URL_ADD_AUTRE;

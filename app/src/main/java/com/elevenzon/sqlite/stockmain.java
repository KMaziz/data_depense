...
public class stockmain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycler_viewcstock);
        actionButton = (FloatingActionButton) findViewById(R.id.addstock);
        displayNotes();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, updateProductUrl,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        stockAdapter adapter = new stockAdapter(getApplicationContext(), stockmain.this, arrayList);
    ...
    public void showDialog() {
        ...
        edittext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(stockmain.this, date, myCalendar
            ...
            public void onClick(View v) {
                if (title.getText().toString().isEmpty()) {
                  ...
                  //  des.setError("Please Enter price");
                    ...
                    String updateProductUrl = server.URL_ADD_STOCK;
